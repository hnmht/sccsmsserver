...
var tables []table = []table{
	...
	},
	{
		...
		CreateSQL: `
			...
			createtime timestamp with time zone default current_timestamp,
			creatorid int DEFAULT 0,
			confirmtime timestamp with time zone default to_timestamp(0),
			confirmerid int DEFAULT 0,
			modifytime timestamp with time zone default to_timestamp(0),
	...
	},
	{
		...
		CreateSQL: `
			...
			description varchar(256),
			status smallint default 0,
			workdate timestamp with time zone default current_timestamp,
			createtime timestamp with time zone default current_timestamp,
			creatorid int DEFAULT 0,
			confirmtime timestamp with time zone default to_timestamp(0),
			confirmerid int DEFAULT 0,
	...
	},
	{
		...
		CreateSQL: `create table executionorder_b (
			...
			isrequirefile smallint default 0,
			isonsitephoto smallint default 0,
			isissue smallint default 0,
			isrectify smallint default 0,
			ishandle smallint default 0,
			issueownerid int default 0,
			handlestarttime timestamp with time zone default current_timestamp,
			handleendtime timestamp with time zone default current_timestamp,
			status smallint default 0,
	...
	},
	{
		...
		CreateSQL: `create table executionorder_comment(
			...
			readtime timestamp with time zone default to_timestamp(0),
	...
	},
	{
		...
		CreateSQL: `
			...
			releasedate timestamp with time zone default to_timestamp(0),
